...
do
    ...
    ./llvm-valida/build/bin/llvm-objcopy -O binary ./buildValidaTests/$test.out ./buildValidaTests/$test.out.bin
    ./valida/target/release/valida run ./buildValidaTests/$test.out.bin ./buildValidaTests/$test.log
    ./valida/target/release/valida prove ./buildValidaTests/$test.out.bin ./buildValidaTests/$test.proof
    ./valida/target/release/valida verify ./buildValidaTests/$test.out.bin ./buildValidaTests/$test.proof
done

TESTS="2023-11-gt 2023-11-lt 2023-12-and 2023-12-div 2023-12-eq 2023-12-ishl 2023-12-ishr 2023-12-log-and 2023-12-log-not 2023-12-mul 2023-12-muli 2023-12-ne 2023-12-not 2023-12-or 2023-12-shl 2023-12-shr 2023-12-shri 2023-12-sra 2023-12-sub 2023-12-subi 2023-12-xor 2023-12-divi 2023-12-divi-signed 2024-1-gti 2024-1-lti 2024-1-ilt 2024-1-or 2024-1-address-of-value-on-stack 2024-3-gte 2024-3-gtei 2024-3-igte 2024-3-lte 2024-3-ltei 2024-3-ilte"
for test in ${@:-${TESTS[@]}}
do
	echo $test
	./llvm-valida/build/bin/clang -c -target delendum ./llvm-test-suite/SingleSource/UnitTests/$test.c -o ./buildValidaTests/$test.o
	./llvm-valida/build/bin/ld.lld --script=./llvm-valida/valida.ld -o ./buildValidaTests/$test.out ./buildValidaTests/$test.o
	./llvm-valida/build/bin/llvm-objcopy -O binary ./buildValidaTests/$test.out ./buildValidaTests/$test.out.bin
	timeout 3 ./valida/target/release/valida run ./buildValidaTests/$test.out.bin ./buildValidaTests/$test.log
